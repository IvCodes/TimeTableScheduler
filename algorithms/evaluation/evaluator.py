import numpy as np
from algorithms.data.loader import Activity  # Import Activity class from data loading module
...
if __name__ == "__main__":
    from algorithms.data.loader import spaces_dict, groups_dict, activities_dict, slots, lecturers_dict
