...
import numpy as np
from algorithms.metrics.calculator import calculate_hypervolume, calculate_spacing, calculate_igd, extract_pareto_front
...
class MetricsTracker:
    ...
    def __init__(self):
        ...
        # Add a key to store the final Pareto front points
        self.metrics["final_pareto_front"] = []
